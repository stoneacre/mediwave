...
<div class="font-semibold text-ColorBlack">
  <ServiceBadge>
    Therapist Profiles - Warm, professional profiles that help patients connect
    with the right provider
  </ServiceBadge>
  <ServiceBadge>
    Online Appointment Booking - Secure, HIPAA-compliant scheduling integrated
    directly into your website
  </ServiceBadge>
  <ServiceBadge>
    Resource Library - Educational content that positions you as a trusted
